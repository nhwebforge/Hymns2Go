/**
 * Import hymns from African American Heritage Hymnal (AAHH2001) on Hymnary.org
 *
 * Usage: npx tsx scripts/import-aahh2001.ts
 */

import { prisma } from '../lib/db/prisma';
import { parseHymnText } from '../lib/hymn-processor/parser';

const HYMNAL_CODE = 'AAHH2001';
...
async function main() {
  console.log(`Starting import from African American Heritage Hymnal (${HYMNAL_CODE})...`);
