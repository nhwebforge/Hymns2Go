/**
 * Import hymns from Gather Comprehensive Second Edition (GG2013) on Hymnary.org
 *
 * Usage: npx tsx scripts/import-gg2013.ts
 */

import { prisma } from '../lib/db/prisma';
import { parseHymnText } from '../lib/hymn-processor/parser';

const HYMNAL_CODE = 'GG2013';
...
async function main() {
  console.log(`Starting import from Gather Comprehensive Second Edition (${HYMNAL_CODE})...`);
