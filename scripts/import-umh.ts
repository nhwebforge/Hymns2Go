/**
 * Import hymns from United Methodist Hymnal (UMH) on Hymnary.org
 *
 * Usage: npx tsx scripts/import-umh.ts
 */

import { prisma } from '../lib/db/prisma';
import { parseHymnText } from '../lib/hymn-processor/parser';

const HYMNAL_CODE = 'UMH';
...
async function main() {
  console.log(`Starting import from United Methodist Hymnal (${HYMNAL_CODE})...`);
