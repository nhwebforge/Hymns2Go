/**
 * Import hymns from Church Praise & Music (CPAM2000) on Hymnary.org
 *
 * Usage: npx tsx scripts/import-cpam.ts
 */

import { prisma } from '../lib/db/prisma';
import { parseHymnText } from '../lib/hymn-processor/parser';

const HYMNAL_CODE = 'CPAM2000';
...
async function main() {
  console.log(`Starting import from Church Praise & Music (${HYMNAL_CODE})...`);
