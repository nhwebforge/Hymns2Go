/**
 * Import hymns from Lutheran Service Book (LSB2006) on Hymnary.org
 *
 * Usage: npx tsx scripts/import-lsb2006.ts
 */

import { prisma } from '../lib/db/prisma';
import { parseHymnText } from '../lib/hymn-processor/parser';

const HYMNAL_CODE = 'LSB2006';
...
async function main() {
  console.log(`Starting import from Lutheran Service Book (${HYMNAL_CODE})...`);
