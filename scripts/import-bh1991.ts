/**
 * Import hymns from Baptist Hymnal (BH1991) on Hymnary.org
 *
 * Usage: npx tsx scripts/import-bh1991.ts
 */

import { prisma } from '../lib/db/prisma';
import { parseHymnText } from '../lib/hymn-processor/parser';

const HYMNAL_CODE = 'BH1991';
...
async function main() {
  console.log(`Starting import from Baptist Hymnal (${HYMNAL_CODE})...`);
